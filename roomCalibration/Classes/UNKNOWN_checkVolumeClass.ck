...
public class VolumeCheck {
    ...
    fun float measureAvgVolume(int note, int vel, int repeats, string address, oscSends osc) {
        0.0 => float total;
        ...
        fun float measureVolume(int note, int vel, int repeats, string address, oscSends osc) {
            0.0 => float total;
            osc.init("localhost", 50000);
            <<< "----- Measuring note", note, "-----" >>>;
